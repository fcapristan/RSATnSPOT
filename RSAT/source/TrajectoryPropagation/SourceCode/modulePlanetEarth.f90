...
!############################################## 
 ...
 double precision , parameter :: omega = 2.0*Pi/(86164.0906) !angular velocity 

 double precision , parameter :: gamma = 1.4D0
 double precision , parameter :: rho0 = 1.225D0
 double precision , parameter :: Rgas = 287.0D0
 double precision , parameter :: Temp0 = 288.15D0
 double precision , parameter :: g0 = 9.8D0
 double precision , parameter :: Hscale = 287.0D0*288.15D0/9.8D0 !Rgas*Temp0/g0
